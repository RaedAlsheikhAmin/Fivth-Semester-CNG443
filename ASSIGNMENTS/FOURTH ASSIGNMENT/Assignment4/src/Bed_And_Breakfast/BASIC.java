...
public class BASIC extends Thread{
    ...
    public static void main(String [] args){
        BASIC bnb=new BASIC();
        //PopulateData.initializeData(bnb); //no need to  populatedata class anymore because IO will handle it.
        Main main = new Main(bnb);//to call the constructor of Main Gui class.
        Thread t1= new Thread(main);//making thread object out of gui main form.
