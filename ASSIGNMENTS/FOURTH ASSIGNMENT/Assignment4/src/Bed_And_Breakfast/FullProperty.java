...
public class FullProperty extends Property{
    ...
    public FullProperty(int propertyId, int numberOfBedrooms, int numberOfRooms, String city, float priceperday, double propertysize) {
        super(propertyId, numberOfBedrooms, numberOfRooms, city, priceperday);
        Propertysize = propertysize;
    }
