...
public abstract class User implements Serializable {
    ...
    public String getDateOfBirthAsString() {
        ...
        return outputDateFormat.format(this.dateOfBirth);
    }
    ...
    public String getregistrationdateAsString() {
        SimpleDateFormat outputDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        return outputDateFormat.format(this.registerationdate);
    }
    ...
    public abstract double getTaxNumber();
    public abstract String getPreferredPaymentMethod();
    public abstract int getGoldlevel();
